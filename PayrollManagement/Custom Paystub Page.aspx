<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Custom Paystub Page.aspx.cs" Inherits="PayrollManagement.Custom_Paystub_Page" %>
    ...
    <form id="form1" runat="server" style="border:36px;">
        ...
        <p>&nbsp;<asp:Label ID="NetPayLabel" runat="server" Text="Net Pay: "></asp:Label>
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <asp:Button ID="Button1" runat="server" Text="Print Paystub" OnClick="Button1_Click" />
          <br/>
    </form>
